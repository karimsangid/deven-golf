export function GolferSwingSVG() {
  return (
    <svg
      ...
      className="golfer-swing"
    >
      {/* Body */}
      <circle cx="60" cy="25" r="8" fill="rgba(201,160,84,0.6)" />
      {/* Torso */}
      <line x1="60" y1="33" x2="60" y2="65" stroke="rgba(201,160,84,0.6)" strokeWidth="2.5" strokeLinecap="round" />
      {/* Left leg */}
      <line x1="60" y1="65" x2="48" y2="95" stroke="rgba(201,160,84,0.6)" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="48" y1="95" x2="44" y2="110" stroke="rgba(201,160,84,0.6)" strokeWidth="2.5" strokeLinecap="round" />
      {/* Right leg */}
      <line x1="60" y1="65" x2="72" y2="95" stroke="rgba(201,160,84,0.6)" strokeWidth="2.5" strokeLinecap="round" />
      <line x1="72" y1="95" x2="76" y2="110" stroke="rgba(201,160,84,0.6)" strokeWidth="2.5" strokeLinecap="round" />
      {/* Arms + Club group */}
      <g className="club">
        {/* Arms reaching to club */}
        <line x1="60" y1="42" x2="50" y2="52" stroke="rgba(201,160,84,0.6)" strokeWidth="2.5" strokeLinecap="round" />
        <line x1="50" y1="52" x2="45" y2="48" stroke="rgba(201,160,84,0.6)" strokeWidth="2.5" strokeLinecap="round" />
        {/* Club shaft */}
        <line x1="45" y1="48" x2="30" y2="15" stroke="rgba(201,160,84,0.8)" strokeWidth="1.5" strokeLinecap="round" />
        {/* Club head */}
        <rect x="26" y="12" width="8" height="4" rx="1" fill="rgba(201,160,84,0.8)" transform="rotate(-10 30 14)" />
      </g>
      {/* Ball */}
      <circle className="ball" cx="44" cy="110" r="3" fill="rgba(255,255,255,0.8)" />
    </svg>
  );
}
